...
-- ----------------------------
DROP TABLE IF EXISTS `##area(已分别建表)`;
...
-- ----------------------------
-- Records of ##area(已分别建表)
-- ----------------------------

-- ----------------------------
-- Table structure for `##category_combo(暂时不考虑套餐)`
-- ----------------------------
DROP TABLE IF EXISTS `##category_combo(暂时不考虑套餐)`;
...
-- ----------------------------
-- Records of ##category_combo(暂时不考虑套餐)
-- ----------------------------

-- ----------------------------
-- Table structure for `##combo(暂时不考虑套餐)`
-- ----------------------------
DROP TABLE IF EXISTS `##combo(暂时不考虑套餐)`;
...
-- ----------------------------
-- Records of ##combo(暂时不考虑套餐)
-- ----------------------------

-- ----------------------------
-- Table structure for `##dish_price_group(暂时不考虑价格组)`
-- ----------------------------
DROP TABLE IF EXISTS `##dish_price_group(暂时不考虑价格组)`;
...
-- ----------------------------
-- Records of ##dish_price_group(暂时不考虑价格组)
-- ----------------------------
...
-- Records of dish
-- ----------------------------
INSERT INTO `dish` VALUES ('0ba8859f3ec64fe659f767402caac6d4', '26d3fcb43dedde30903d1b9195ab8b9f', '37c4d5c3eee381e71b113c55545dc329', '牛柳', '0', null, null, '12.55', '1368773026', '1368773026');
INSERT INTO `dish` VALUES ('964942f7294d96ede5e5fe3d55397daf', '26d3fcb43dedde30903d1b9195ab8b9f', '62f9853c4db7ac7cb77bd3eba536040c', '海鲜面', '1', null, null, '14.00', '1368776078', '1368781580');
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('26d3fcb43dedde30903d1b9195ab8b9f', '0', '1368415819', '1368757190');
