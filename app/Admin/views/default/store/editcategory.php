    ...
    <div class="list">
        ...
        <table>
            <tr>
                ...
                <td class="value"><input type="txt" class="txt category-store-id" name="category_store_id" value="<?php echo $category_store_id; ?>" readonly /></td>
            </tr>
            <tr>
                <td class="label">分类名称：</td>
                <td class="value"><input type="txt" class="txt category-store-name" name="category_store_name" value="<?php echo $category_store_name; ?>" /></td>
            </tr>
            <tr>
                <td class="label"></td>
                <td class="value">
                    <button type="button" class="submit">编辑</button>
